...
abstract class $UserInfoCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? avatar, String? status, String? date});
}
...
class _$_UserInfo implements _UserInfo {
  _$_UserInfo({this.id, this.avatar, this.status, this.date});
  ...
  @override
  String toString() {
    return 'UserInfo(id: $id, avatar: $avatar, status: $status, date: $date)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, avatar, status, date);
